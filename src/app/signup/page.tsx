      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Sign up to Iterova to continue</p>
          </div>
        </div>
              ...
              {fieldErrors.name && (
                <>
                  <div className="flex items-center gap-1 pt-1">
                    ...
                    <p className="text-sm text-red-500">{fieldErrors.name.errors[0]}</p>
                  </div>
                </>
              )}
            </div>
              ...
              {fieldErrors.confirmPassword && (
                <>
                  <div className="flex items-center gap-1 pt-1">
                    ...
                    <p className="text-sm text-red-500">{fieldErrors.confirmPassword.errors[0]}</p>
                  </div>
                </>
              )}
            </div>
